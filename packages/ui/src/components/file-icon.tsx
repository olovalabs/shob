...
export const FileIcon: React.FC<FileIconProps> = ({ node, class: _class, classList, expanded, mono, ...rest }) => {
  const name = useMemo(() => chooseIconName(node.path, node.type, expanded || false), [node.path, node.type, expanded])
