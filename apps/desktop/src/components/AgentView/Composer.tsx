    ...
    >
      <div className="w-full px-3 pointer-events-auto md:max-w-[800px] md:mx-auto 2xl:max-w-[1000px]">
        ...
        <div className="relative z-10">
          <div className="agent-composer group/prompt-input focus-within:shadow-xs-border relative z-10 overflow-clip rounded-[12px] bg-[var(--surface-raised-stronger-non-alpha)] shadow-[var(--shadow-xs-border)]">
            <textarea
              ref={textareaRef}
              value={input}
              ...
              disabled={!project}
              rows={1}
              className="w-full max-h-[200px] min-h-[52px] resize-none overflow-y-auto bg-transparent px-3.5 pb-14 pt-3 text-[14px] leading-[1.5] text-foreground placeholder:text-muted-foreground/70 focus:outline-none disabled:cursor-not-allowed disabled:opacity-60 no-scrollbar"
            />

            <div
              aria-hidden="true"
              className="pointer-events-none absolute inset-x-0 bottom-[42px] h-7"
              style={{ background: "linear-gradient(to top, var(--surface-raised-stronger-non-alpha), transparent)" }}
            />
